...
\begin{columns}[t]
  ...
  \begin{column}{0.32\linewidth}
    ...
    \begin{block}{Scenario: The crowd-counting problem}
      \begin{itemize}
    ...
    \item\label{UniversalVerif} Universal verifiability: anyone can verify that 
      the result is according to the submitted participation proofs.
  ...
  \begin{column}{0.32\linewidth}
    ...
    \begin{block}{Designated protest}
      \begin{itemize}
    ...
    \begin{block}{Privacy-preserving linkability}
      \begin{itemize}
    ...
    \begin{block}{Temporal eligibility}
      \begin{itemize}
    ...
    \begin{block}{Location proofs and spatial eligibility}
      \begin{itemize}
...
\begin{block}{Verifying the participation count}
...
\begin{block}{Eligibility and universal verifiability}
...
\begin{block}{Individual verifiability and receipt freeness}
    ...
    \begin{figure}
      ...
      \begin{minipage}{\linewidth}
        \begin{align*}
          ...
          & wsig = PRF_{k_W}(wid, t_s, l), \exists sign(k_W)) \\

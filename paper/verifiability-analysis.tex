...
\Cref{CountOnce} prevents Sybil attacks, in the sense
...
Relaying the communication is \iac{DBDF} attack against the \ac{DB} protocol.
...
Finally, in the case of trusted witnesses, Alice's chance of corrupting 
witnesses is reduced to the trustworthiness of the witnesses chosen by the 
verifier.

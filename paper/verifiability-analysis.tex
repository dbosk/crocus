...
As we will show, it follows from \cref{analysis-individual} that the adversary cannot drop 
submitted proof shares and thus cannot decrease the count.
As indicated in \cref{in-system-adversary,deanonymizing-storage-adversary}, the 
...
has an incentive to increase the count, as the organizer and participant.

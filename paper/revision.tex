...
\newcommand{\daniel}[1]{\annote{#1}{Daniel}{olive}}
\newcommand{\sonja}[1]{\annote{#1}{Sonja}{red}}
\newcommand{\seb}[1]{\annote{#1}{Seb}{blue}}
\newcommand{\henri}[1]{\annote{#1}{Henri}{brown}}
\newcommand{\simon}[1]{\annote{#1}{Simon}{orange}}

...
However, in the worst case, the \ac{DBMF} adversary will be detected in the 
first round, since he cannot buffer any response from the prover.
After the first round though, the adversary knows \(b\) and can get those 
requests as quickly as possible from the prover.
By repeating the protocol we decrease this probability.

...
However, ProProx provides \iac{DBPK} protocol for quadratic residues (\ie protocols of the form \(\DBPK[\alpha][a = \alpha^2]\)) while in our context, we need \iac{DBPK} protocol for discrete logarithms (\ie \(\DBPK[\alpha][a = g^\alpha]\)).

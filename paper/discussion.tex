...
\paragraph*{Mobile ad-hoc networks}
...
As to the storage~\(S\), this is equivalent to the adversarial storage \(S\) 
...
%\Cref{deanonymizing-storage-adversary} is a rather strong adversary,  against 
...
%hard to achieve.
%
%Say that Alice uses something like Tor, even if Grace can do a time-correlation 

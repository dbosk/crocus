...
\sonja{\subsection{Performance}
- performance: important during protest due to resource-constrained devices (battery, computational power, storage) and limited network capacity. Less important after, at other locations with plugged-in devices. Include evaluation environment, parameters, results, disclaimer about parts that cannot yet be implemented and evaluated because the hardware doesn't exist yet for DB on phones}

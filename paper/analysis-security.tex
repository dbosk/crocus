...
\Cref{UniversalVerif} requires also that anyone can check the result and that all participation proofs counted are legitimate.
...
\Cref{CountOnce} is required to prevent Sybil attacks, in the sense that Alice cannot provide two participation proofs for specific protest and thus be counted twice.

...
%Seb: the starting and ending time of the protest could also be included in the manisfest if we wanted to 
...
\begin{requirements}[V]
  \item\label{EligibilityVerif} \emph{Eligibility}: anyone can verify that each participation proof provides temporal and spatial eligibility and that only one participation proof is counted per individual.
    ...
    %Seb: this property seems to be related to the eligibility property in the sense that if a participant tries to submit a second proof this directly conflicts with the eligibility

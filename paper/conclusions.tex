...
\daniel{I think that we can move Mallory to the discussion, because Mallory 
  cannot get valid credentials for herself as a foreign state.}
...
She cannot create keys valid in another nation state.

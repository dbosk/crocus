...
These rallies were all in the same location in the capital and repeated every weekend for the duration of a few weeks.
...
A witness is only allowed to create one proof share per protester to
avoid the risk of count inflation.
...
The participation proof and its proof shares are stored in a set, as
there should only be unique proof shares.
...
% proof
% proofs
\sonja{what is the subscript i and do we need to have it here?}

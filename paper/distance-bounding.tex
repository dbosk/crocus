...
%by measuring the time-of-flight of short challenge-response messages (or 
%rounds) exchanged during time-critical phases. Time critical phases are 
%complemented by slow phases during which the time is not taken into account. At 
%the end of a \Ac{DB} protocol, the verifier should be able to

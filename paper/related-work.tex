...
%, which should be similar as in our discussion about the verifiability of photos (\ie, using forensic methods).
...
%For instance, if Alice has organized a protest against Grace's regime, 

...
\daniel{The main idea is that the adversary cannot link the protester's real 
  identity \(P\) to the protest cause \cid.}
...
\daniel{End of edits so far.}

\sonja{discussion about applicable properties here, more sources and 

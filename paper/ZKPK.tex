...
\NewCryptoScheme{\Schn}{Schn}
\NewAlgorithm{\SchnProve}{\Schn.\!Prove}
\NewAlgorithm{\SchnVerify}{\Schn.\!Verify}
...
\NewCryptoScheme{\PKscheme}{PK}
\NewAlgorithm{\PKprove}{\PKscheme.\!Prove}
\NewAlgorithm{\PKverify}{\PKscheme.\!Verify}
...
\NewAlgorithm{\Prove}{Prove}
\NewAlgorithm{\Verify}{Verify}
\NewCryptoSet{\PKG}{G}
\NewCryptoSet{\PKA}{A}
\NewCryptoSet{\PKS}{S}
...
\begin{figure*}
  \begin{minipage}{0.49\linewidth}
    \begin{algorithmic}
      \Function{$\PKprove^S$}{$\PKG, q, A, \PKA$}
        \For{$0\leq i\leq \log\lambda$}
          \State{$\method{S}{\Prove[\PKG, q, A, \PKA][_{k = \log\lambda}]}$}
        \EndFor{}
      \EndFunction{}
    \end{algorithmic}
  \end{minipage}
  \begin{minipage}{0.49\linewidth}
    \begin{algorithmic}
      \Function{$\PKverify^S$}{$\PKG, q, A$}
        \For{$0\leq i\leq \log\lambda$}
          \State{$\method{S}{\Verify[\PKG, q, A][_{k=\log\lambda}]}$}
        \EndFor{}
      \EndFunction{}
    \end{algorithmic}
  \end{minipage}
...
\NewCryptoScheme{\SSchn}{SSchn}
\NewAlgorithm{\SPKprove}{\SSchn.\!Prove}
\NewAlgorithm{\SPKverify}{\SSchn.\!Verify}

...
participants as high as possible whereas the regime's incentive is to make 
this estimation as low as possible to support Eve.
%                                                                                  
% What's the approach?
In this work, we combine location proofs with some 
properties of electronic voting to provide verifiable yet
privacy-preserving participation counts.
...
other participants.
We use blockchains to commit and timestamp the participation proofs,
which essentially consist of location 
proofs by distance bounding to prove connection to the physical location.
% What's the result?

...
to prevent the regime in place from dropping data --- and that anyone can verify the correctness of the result --- \emph{i.e.}\ universal and eligibility verifiability, to prevent any malicious actor (\emph{e.g.}, Sybil attack) from affecting the result.

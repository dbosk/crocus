\begin{abstract}
  ...
  based on future smartphones that combines anonymous credentials, distance 
  bounding, and storage on a public ledger to
  ...
  correctly.
%  We find that, with some assumptions about the

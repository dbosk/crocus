...
and Schnorr comes had the right idea, but does not fulfil the requirements of 
modern distance-bounding protocols.
% % What's the problem?
We need a secure distance-bounding zero-knowledge proof-of-knowledge resisting 
...
We construct such a protocol and prove it secure in the (extended) DFKO model 

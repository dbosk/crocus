...
to prevent the regime in place from dropping data --- and that anyone can verify the correctness of the result --- \ie universal and eligibility verifiability, to prevent any malicious actor (\eg Sybil attack) from affecting the result.

...
As a consequence, as this block will remain, we are also sure that our data stay committed.\sonja{`` --- even if we no longer remember what our data looked like.'' This was commented out, but the question remains: can we still count?}

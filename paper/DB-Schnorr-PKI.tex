...
\begin{figure*}
  ...
  \begin{tabular}{p{0.40\linewidth}cp{0.40\linewidth}}
    ...
    \midrule
    \multicolumn{3}{c}{\textbf{Signature reblinding}} \\
...
\paragraph*{Signature reblinding}
...
This blinding procedure can be done once, there is no point in presenting the 
verifier with several different blindings of the same signature.

\paragraph*{Setup}

Now we prepare for the actual \acl{DB}.
The prover chooses \[
  \rho\rgets \ZZ_q, \quad

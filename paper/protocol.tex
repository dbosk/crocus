...
sybil-proof identity and a cryptographic key, more specifically, an anonymous 
identity credential that provides unlinkability between contexts but 
linkability for reuse within the same context\footnote{%
...
evidence, all in \cref{ProtocolDuring}) with an overview in \cref{fig:ProtocolOverview}, and then counting and

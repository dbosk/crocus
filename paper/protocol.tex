...
\cref{security-properties}), \ie count the number of participants (of the 
protest and the protocol) or verify anyone else's count given the relevant meta 
data (which protest, location, time, and witness parameters used in the

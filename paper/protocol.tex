...
\NewAlgorithm{\PRIVOsetup}{\PRIVOscheme.\!Setup}
\NewAlgorithm{\PRIVOjoin}{\PRIVOscheme.\!Join}
\NewAlgorithm{\PRIVOparticipate}{\PRIVOscheme.\!Participate}
\NewAlgorithm{\PRIVOsubmit}{\PRIVOscheme.\!Submit}
...
submission phases.
We have an identification authority \(\ID\), an organizer Oscar, \(\O\), a 
protester Alice (\(\A\)) and a witness Bob \(\B\).

\NewCryptoEntity{\ID}{ID}

\emph{Setup.}
During the setup phase, we set up the needed keys.

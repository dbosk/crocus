...
We now present \PRIVO, a protocol for securely and privately verifying crowd 
counts.
...
\emph{Submission: \(\psh_P\gets \PRIVOsubmit[_P][\cid, \pid, \wid, t_s, t_s', 
    l]\).}
...
Finally, the participant uploads the tuple \[
  \psh_P = (\cid, \pid, \wid, t_s, t_s', t_e, l, \pi_{\pid})
...
Finally, the witness uploads the tuple \[
  \psh_W = (\pid, \wid, t_s, t_s', t_e', l, \pi_{\wid})
\] for permanent storage.

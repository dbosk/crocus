...
During the setup step, the \ac{CA} creates all the needed keys.
...
The join, participation and submission steps are illustrated in \cref{fig:ProtocolOverview}.
The participation proof share that will be constructed in the participation step is illustrated in \cref{fig:ProofFig}.

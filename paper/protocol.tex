...
person's identity and a cryptographic key\footnote{%
  This can be done by any \emph{logically} centralized 
  authority~\cite{SybilAttack}.
  Although a decentralized authority, as in the case of a collective 
  authority~\cite{collective-signing} powered by 
  proof-of-personhood~\cite{proof-of-personhood}, would be desirable, we think 
  that this has scalability issues.
  See the detailed discussion in \cref{identity-limits}.
  We will also return to this topic in \cref{Discussion}.
}.

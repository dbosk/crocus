...
\Ie a user remains unlinkable between different interactions, yet cannot use it 
twice (or \(n\) times) at the same time, \eg for sharing with a friend.
We will use this to prevent reuse within the same event (protest) rather than 

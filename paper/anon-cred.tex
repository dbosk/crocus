...
\NewCryptoScheme{\ACscheme}{AC}
\NewAlgorithm{\ACcommit}{\ACscheme.\!Commit}
\NewAlgorithm{\ACeq}{\ACscheme.\!ProveEqual}
\NewAlgorithm{\ACreq}{\ACscheme.\!ReqSign}
\NewAlgorithm{\ACissue}{\ACscheme.\!IssueSign}
\NewAlgorithm{\ACprove}{\ACscheme.\!ProveSign}

The anonymous credential system, \(\ACscheme\), that we require shares the core 
idea of Anon-Pass~\cite{AnonPass}.

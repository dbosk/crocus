...
In theory, this class of methods will provide an upper bound, whereas our 
method provides a lower bound.
...
\mode<presentation>{%
\subsection{Signal-based methods}
}
...
eligibility verification, \cref{EligibilityVerif}).

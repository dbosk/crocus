...
In voting, we have the following alternative requirements:
\begin{frame}
...
Hence, if Alice submits a proof to the block chain, it must be unlinkable to 
Alice yet if Alice submits another proof, those two proofs must be linkable.

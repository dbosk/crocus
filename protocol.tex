...
There are exactly two properties that we need.
...
it was committed.
For \cref{CreatedAfterStart} Alice and Bob must include the hash value of a 
...
\subsection{Location proofs and spatial eligibility}

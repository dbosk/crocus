...
the hash value of the manifesto as identifier of the protest.
(As shown as manifesto and \(id\) in \cref{ProofFig}.)
...
Thus \(pid\) will be used as the unique identifier in the proof shares and the 
\ac{NIZK} proof will prove the eligibility of \(pid\).

\subsubsection{Temporal eligibility}

Given the properties of the storage (in \cref{StorageProperties}), 
...
existing block in the blockchain (\(t_s\) in \cref{ProofFig}).

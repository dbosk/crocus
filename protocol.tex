...
\begin{itemize}
  \item Alice the organizer,
  \item Bob the participating protester,
  \item Jane the trustworthy journalist,
  \item Eve the evil autocrat, and finally
  \item Rusuk the foreign nation state.
\end{itemize}
